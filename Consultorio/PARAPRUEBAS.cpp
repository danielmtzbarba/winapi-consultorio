...
LRESULT CALLBACK ReporteMedicosProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam);
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE, LPSTR, int nCmdShow) {
    ...
    HWND hWnd = CreateWindowEx(0, L"MainWindowClass", L"ventana de Prueba",
